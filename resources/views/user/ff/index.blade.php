    ...
    <section class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 p-5 mt-3" >
                <a href="{{ route('category',["category"=>$item->category])}}"><img src="{{ asset('imgs').'/'.$item->path }} " style="min-height: 340px ; max-height: 350px;min-width:340px" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">{{ Str::upper($item->category)  }}</h5>
                <p class="text-center"><a class="btn btn-success" href="{{ route('category',["category"=>$item->category])}}">Go Shop</a></p>
            </div>
            @endforeach
